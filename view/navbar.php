...
?>
                ...
                <button onclick="document.forms.searchForm.page.value=1"
                    class="btn btn-outline-success my-2 my-sm-0 mr-2" type="submit">
                    Search
                </button>
                <button onclick="location.href='<?=$pageUrl?>'" class="btn btn-outline-warning my-2 my-sm-0"
                    type="button">
